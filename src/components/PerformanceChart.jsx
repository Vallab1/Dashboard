...
const PerformanceChart = ({ items }) => {
    ...
    return (
        <div className='bg-[#1E2B48] rounded-2xl px-4 sm:px-6 md:px-8 py-5  mt-6 text-white shadow-sm transition-all duration-300 ease-in-out 
        w-full mx-auto text-left overflow-x-auto'>
            ...
            <div className='flex flex-wrap gap-2 mb-6'>
                {tabs.map((tab) => (
                    <button
                        ...
                        className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-all duration-300 ${active === tab
